...
/*!
 * \file  
 * \brief Zawiera definicje dluzszych metod klasy \link Prostopadloscian \endlink
 *
 *  Zawiera definicje dluzszych metod klasy \link Prostopadloscian \endlink
 *
 */

void Prostopadloscian::Wyznacz_Promien_i_Srodek()
{   
...
bool Prostopadloscian::WyznaczWsp()
{
    std::ifstream Strm(PodajNazwePlikuLok()); /*Odczyt danych z pliku*/
