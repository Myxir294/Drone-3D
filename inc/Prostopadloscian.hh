...
/*!
 * \file  
 * \brief Zawiera definicję klasy Prostopadloscian
 *
 *  Plik zawiera definicję klasy Prostopadloscian, sluzacej do
 *  interpretacji zadanego obiektu jako prostopadloscianu majacego
 ...
 */
/*!
 * \brief Prostopadloscian jako bryla przestrzenna o promieniu i srodku lokalnym
 *
 *  Definicja klasy Prostopadloscian, sluzacej do
 *  interpretacji zadanego obiektu jako prostopadloscianu majacego
 *  okreslone wspolrzedne w ukladzie kartezjanskim. Ponadto obiekt
 *  zapamietuje wartosc swojego promienia oraz lokalne polozenie swojego
 *  srodka. 
 */
class Prostopadloscian: public ObiektSceny
{
    /*!
